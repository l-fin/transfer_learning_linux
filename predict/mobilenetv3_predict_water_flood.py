...
data_dir = '../train/data/water_flood'
...
model_conv = torch.load("../train/mobilenetv3_model_conv_water_flood.pth")

model_conv = model_conv.to(device)

# In[6]:

data_dir_flood = '../train/data/water_flood/test/flood'
data_dir_non_flood = '../train/data/water_flood/test/non-flood'
